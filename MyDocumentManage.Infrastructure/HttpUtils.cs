...
namespace MyDocumentManage.Infrastructure
{
    public static class HttpUtils
    {
        ...
        public static async Task<string> HttpGetAsync(string url, Encoding encoding = null)
        {
            ...
            var Result = encoding.GetString(result);
            return Result;
        ...
        public static async Task<string> HttpPostAsync(string url, CookieContainer cookieContainer = null, Stream postStream = null, Dictionary<string, string> fileDictionary = null, string refererUrl = null, Encoding encoding = null, int timeOut = 10000, bool checkValidationResult = false)
        {
            ...
            HttpClient client = new HttpClient(handler);
            HttpContent hc = new StreamContent(postStream);
            //add encoding 2106-10-30
            //if(encoding!=null)
            //    client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("text/html;charset="+encoding.WebName));
